...
export const Default = (props: FooterSectionProps): JSX.Element => {
  ...
  return (
    <footer className={`component footer-section ${styles || ''}`} id={id}>
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 lg:gap-6">
            {sections.map(({ key, title, content }) => (
              <div key={key} className="footer-column">
                <h4 className="mb-4 text-base font-bold text-[#1A1A2E] lg:text-lg">{title}</h4>
      ...
      {/* Bottom Bar: Logo, Country Selector, Social, Legal */}
      <div className="bg-white py-8 lg:py-10">
        <div className="mx-auto max-w-7xl px-4">
          {/* Logo + Country Selector + Social Icons */}
          ...
          {/* Legal Links */}
          <div className="mb-4 flex flex-wrap items-center gap-2 text-sm text-[#1A1A2E]">
            <SitecoreLink
