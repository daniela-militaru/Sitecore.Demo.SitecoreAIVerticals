...
import { TextField, RichTextField, LinkField, Text, RichText, Link as SitecoreLink } from '@sitecore-content-sdk/nextjs';
...
export const Default = (props: TestimonialCardProps): JSX.Element | null => {
  ...
  return (
    <div className={`component testimonial-card w-full shrink-0 text-center ${styles || ''}`} id={id}>
      {/* Quote */}
      <RichText
      ...
      <p className="text-sm text-[#1A1A2E]">
        ...
        <Text tag="span" field={fields.Function} />{' '}
        , <Text tag="span" field={fields.Company} />
      </p>
