...
export const Default = (props: StatCardProps): JSX.Element => {
  ...
  return (
    <div className={`component stat-card text-center flex-shrink-0 ${styles || ''}`} id={id}>
      {/* Stat Value - Light cyan/teal color */}
      dsffsdfsd
      <div className="text-4xl md:text-5xl lg:text-5xl font-light text-[#00B5E2] mb-1">
        <Text field={fields.Value} />
      </div>

      {/* Stat Label - Dark blue */}
      <div className="text-sm text-[#003057] leading-snug max-w-[200px] mx-auto">
